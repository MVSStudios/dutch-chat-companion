        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mt-3 font-body text-sm opacity-80">
              Uw droom? Uw wens? Uw reis? Bij J&C Motorhomes uw 2dehands mobilehome aan een betaalbare prijs.
            </p>
             <h3 className="font-heading text-2xl font-bold">J&C Motorhomes</h3>
            <p className="mt-3 font-body text-sm opacity-80">
              Bij J&C Motorhomes uw 2dehands mobilehome aan een betaalbare prijs.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 text-sm opacity-80">
                ...
                <span>Bissegemsestraat 43/003 8501 Kortrijk, België</span>
              </div>
            </div>
          </div>
        </div>
