      ...
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl font-body text-lg text-primary-foreground/85 md:text-xl">
            ...
            Ontdek ons aanbod en rij uw droom tegemoet.
          </p>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {services.map((s) => (
            <div
              key={s.title}
              className="rounded-xl border border-border bg-card p-8 shadow-[var(--shadow-card)] transition-shadow hover:shadow-[var(--shadow-elevated)]"
            >
