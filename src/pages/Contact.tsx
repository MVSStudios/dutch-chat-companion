  ...
  return <div className="container mx-auto px-4 py-12">
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="c-name" required value={form.name} onChange={e => setForm(p => ({
                ...p,
                name: e.target.value
              }))} />
              </div>
              <div className="space-y-2">
                ...
                <Input id="c-email" type="email" required value={form.email} onChange={e => setForm(p => ({
                ...p,
            ...
            <div className="space-y-2">
              ...
              <Textarea id="c-message" rows={5} required value={form.message} onChange={e => setForm(p => ({
              ...p,
        ...
        <div className="space-y-6 lg:col-span-2">
          {info.map(item => <div key={item.label} className="flex items-start gap-4">
